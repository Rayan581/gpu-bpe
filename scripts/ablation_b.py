"""
Ablation B: GPU tokenizer + HSG, NO adaptive compression.

Tests the impact of adaptive quantization by removing it while keeping
GPU tokenizer and HSG.
...
def train_ablation_b(
    ...
    max_length: int = 512,
    num_workers: int = 2,
    save_dir: str = "./outputs/ablation_b",
    device: str = "cuda" if torch.cuda.is_available() else "cpu"
):
    """
    Ablation B: GPU tokenizer + HSG, NO adaptive compression.
    """
    print(f"=== Ablation B: GPU Tokenizer + HSG (NO Adaptive Compression) ===")
    ...
    # GPU tokenizer with HSG
    print("Creating tokenizer (GPU + HSG)...")
    ...
    for worker_id in range(num_workers):
        ...
        worker = TrainingWorker(
            ...
            tokenizer=tokenizer,
            device=device,
            compression_fn=None  # NO compression
        )
    ...
    while step < num_steps:
        ...
        metrics_logger.update(
            ...
            compression_ratio=1.0  # FP32, no compression
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", type=str, default="./outputs/ablation_b")
